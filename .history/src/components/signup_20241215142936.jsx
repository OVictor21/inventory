        ...
        <div className="nav-body border flex-grow-1">
          ...
          <form>
            <div className="sign-up position-relative">
              <div className="mb-3">
                <p className="text1 position-absolute">Sign-up</p>
                <div className="text-wrapper-18 position-absolute">Join Us!</div>
                ...
                <label htmlFor="emailInput" className="form-label emails position-absolute">
                  <span className="emails-text">Email Address</span>
                </label>
                <input type="emails" className="form-control emails-in position-absolute" id="emailInput" />
              </div>
  
              <div className="mb-3">
                <label htmlFor="passwordInput" className="form-label password position-absolute">
