  ...
  return (
    ...
    <div className="nav-body border flex-grow-1">
      <div className="container mx-5 px-5">
        <img src="./logo.png" alt="Logo" className="img-fluid logo mx-auto" style={{ maxWidth: '200px' }} />
      </div>
      ...
      <form>
        <div className="sign-in position-relative">
          ...
          <p className="acct position-absolute">Don't have an account?</p>
          <a href="/createacct" className="acct-1 position-absolute">Create an account</a>
        </div>
      </form>
    </div>
