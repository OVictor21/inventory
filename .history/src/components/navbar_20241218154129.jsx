...
const Navbar = () => {
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item nav-link nav-text" href="/li">Edit Profile</a></li>
    <li><a class="dropdown-item nav-link nav-text" href="/so">Security</a></li>
    <li><a class="dropdown-item nav-link nav-text" href="/aa">Add an Account</a></li>
  </ul>
</div>
            </li>
