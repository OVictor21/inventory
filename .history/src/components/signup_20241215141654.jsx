          ...
          <form>
            <div className="sign-up position-relative">
              ...
              <div className="mb-3">
                ...
                <input type="password" className="form-control pass-in position-absolute" id="passwordInput" />
              ...
              <button type="submit" className="btn sign-btn position-absolute rounded-3 text-white fw-bold">
                Sign Up
              </button>
  
              <div className="acc position-relative">
                <p className="acct position-absolute">Already have an account?</p>
                <a href="/login" className="acct-1 position-absolute">Sign In</a>
              </div>
            </div>
          </form>
        </div>
