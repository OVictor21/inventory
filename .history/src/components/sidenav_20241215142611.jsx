...
const SideNavWithSignup = () => {
  return (
    <div className="d-flex">
      {/* Sidebar with Logo */}
      <div className="bg-dark text-white d-flex flex-column align-items-center p-3 vh-100" style={{ width: '80px' }}>
...
export default SideNavWithSignup;
