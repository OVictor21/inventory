...
<div className="nav-body border">
        ...
        <button type="submit" className="btn sign-btn position-absolute rounded-3 p-3 text-white fw-bold"><span className="sign-text">Sign In</span></button>
      ...
      <footer className="footer-body text-white p-3 justify-content-start mb-5 d-flex align-items-center"> 
