...
const Navbar = () => {
   ...
   <button class="navbar-toggler ms-auto" type="button" data-bs-toggle="collapse"
    ...
    <div className="navbar-collapse collapse" id="collapseNavbar">
        ...
        <ul className="navbar-nav justify-content-center w-100">
            ...
            <li className="nav-item m-2">
                <a className="nav-link nav-text btn btn-primary dropdown-toggle" href="/Notifications" data-bs-toggle="dropdown">Notifications</a>
            </li>
            <li>
            <div class="dropdown">
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="/li">Link 1</a></li>
    <li><a class="dropdown-item" href="/so">Link 2</a></li>
    <li><a class="dropdown-item" href="/aa">Link 3</a></li>
  </ul>
</div>
            </li>
