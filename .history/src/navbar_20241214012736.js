    ...
    return (
        ...
        <div className="navbar-collapse collapse" id="collapseNavbar">
            ...
            <li className="nav-item bg-light">
                <button className="nav-link nav-text-2 text-nowrap btn btn-link rounded">Log out</button>
                <button className="nav-link nav-text-2 text-nowrap btn btn-outline-primary rounded">Log out</button>
