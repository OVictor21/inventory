    ...
    <div className="admin-body min-vh-100 d-flex flex-column justify-content-center align-items-center ">
      <div className="inventory justify-content-center rounded-5 mb-4">
        <div className="inventory-logo position-relative ">
          ...
          <a href="/Inventory " className="admin-text  position-absolute text-decoration-none">Purchase History</a>
        </div>
      </div>
      ...
      <div className="inventory justify-content-center rounded-5 mb-4">
        <div className="inventory-logo position-relative">
          ...
          <a href="/Adduser " className="admin-text  position-absolute text-decoration-none">Inventory Monitor</a>
        </div>
      </div>
    </div>
