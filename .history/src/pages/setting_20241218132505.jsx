  ...
  return (
    ...
    <div className="setting-body min-vh-100 d-flex flex-column position-relative ">
        <div className="setting justify-content-center rounded-2 mb-4 position-absolute ">
          <p className="text-center setting-text">SETTINGS</p>
          <div className="user-logo position-relative ">
            ...
            <a href="/Editprofile" className="user-text  position-absolute text-decoration-none text-nowrap">Edit Profile</a>
            
            <img className="d-block w-100 position-absolute security-logo" src="/security.png" alt="Logo" />
            <a href="/Security " className="security-text  position-absolute text-decoration-none text-nowrap">Security</a>
            ...
            <a href="/Adduser " className="acc-text  position-absolute text-decoration-none text-nowrap">Add an Account</a>
