      ...
      <div className="admin-body min-vh-100 d-flex flex-column justify-content-center align-items-center ">
        <div className="inventory justify-content-center rounded-5 mb-4">
          <div className="inventory-logo position-relative ">
            ...
            <a href="/Inventory " className="admin-text  position-absolute text-decoration-none text">Place Order</a>
          </div>
        </div>
        ...
        <div className="inventory justify-content-center rounded-5 mb-4">
          <div className="inventory-logo position-relative">
            ...
            <a href="/Order " className="admin-text  position-absolute text-decoration-none text">Order History</a>
          </div>
        </div>
        ...
        <div className="inventory justify-content-center rounded-5 mb-4">
          <div className="inventory-logo position-relative">
            ...
            <a href="/Notification " className="admin-text  position-absolute text-decoration-none text">Transaction History</a>
          </div>
        </div>
