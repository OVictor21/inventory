...
const Addremove = () => {
  return (
    <div>
      ...
      <p className="text-center setting-text text-white">ADD </p>
        <div className="inventory justify-content-center rounded-5 mb-4">
          <div className="inventory-logo position-relative ">
            ...
            <a href="/placeorder" className="admin-text  position-absolute text-decoration-none text-nowrap">Add User</a>
          </div>
        </div>
        ...
        <div className="inventory justify-content-center rounded-5 mb-4">
          <div className="inventory-logo position-relative">
            ...
            <a href="/Orderhistory " className="admin-text  position-absolute text-decoration-none text-nowrap">Remove user</a>
          </div>
        </div>
