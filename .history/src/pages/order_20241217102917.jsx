      ...
      <div className="admin-body min-vh-100 d-flex flex-column justify-content-center align-items-center ">
        <div className="inventory justify-content-center rounded-5 mb-4">
          <div className="inventory-logo position-relative ">
            ...
            <a href="/Inventory " className="admin-text  position-absolute text-decoration-none te">Place Order</a>
          </div>
        </div>
        ...
        <div className="inventory justify-content-center rounded-5 mb-4">
          <div className="inventory-logo position-relative">
            ...
            <a href="/Order " className="admin-text  position-absolute text-decoration-none te">Order History</a>
          </div>
        </div>
        ...
        <div className="inventory justify-content-center rounded-5 mb-4">
          <div className="inventory-logo position-relative">
            ...
            <a href="/Notification " className="admin-text  position-absolute text-decoration-none te">Transaction History</a>
          </div>
        </div>
