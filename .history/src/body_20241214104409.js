...
const Body = () => {
  return (
    ...
    <footer className="footer-body text-white p-3 justify-content-start mb-5 d-flex align-items-center"> d-flex align-items-center p-3 justify-content-start mt-5
