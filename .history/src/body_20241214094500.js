...
const Body = () => {
  return (
    ...
    <footer className='footer-body position-relative w-100 bg-body-tertiary h-25'>
    <div className="text-center py-3 copyright-text position-absolute">
            © 2024 Tamiym Workshop. All Rights Reserved.
        </div>
    </footer>
